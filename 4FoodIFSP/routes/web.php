...
Route::middleware('firebase.auth')->group(function () {
    ...
    Route::middleware('force.password.reset')->group(function () {
        Route::prefix('admin')->name('admin.')->group(function () {
            // Telas exclusivas do admin: dashboard, cadastros e conexões do WhatsApp.
            ...
            // Pedidos: admin, cozinha, financeiro e garçom.
            Route::middleware('role:admin|kitchen|finance|waiter')->group(function () {
            ...
            // Cancelar pedido: admin, financeiro e garçom (a cozinha não cancela).
            Route::middleware('role:admin|finance|waiter')->group(function () {
            ...
            Route::prefix('mesas')->name('mesas.')->group(function () {
                // Operacional: admin, financeiro e garçom.
                Route::middleware('role:admin|finance|waiter')->group(function () {
                ...
                // Cadastro de mesas (criar/editar/excluir): somente admin.
                Route::middleware('role:admin')->group(function () {
        ...
        // Dashboards iniciais por departamento (placeholders preservados).
        Route::middleware('role:admin|kitchen')->get('/kitchen/dashboard', function () {
            return Inertia::render('Kitchen/Dashboard');
        })->name('kitchen.dashboard');

        Route::middleware('role:admin|finance')->get('/finance/dashboard', function () {
            return Inertia::render('Finance/Dashboard');
        })->name('finance.dashboard');

        Route::middleware('role:admin|waiter')->get('/waiter/dashboard', function () {
